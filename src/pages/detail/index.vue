    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <ZoomModule :skuImageList="skuImageList" />
          <!--下方的缩略图-->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              <div class="choosed">
                <mark>黑色<a name="0">X</a></mark>
                <mark>公开版<a name="2">X</a></mark>
                <mark>官方标配<a name="3">X</a></mark>
              </div>
              <dl
              ...
              >
                ...
                <dd
                  ...
                  @click="resetSaleAttrValue(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a
                  href="javascript:;"
                  class="mins"
                  @click="productNum>1?productNum--:productNum=1"
                >-</a>
              </div>
              <div class="add">
                <a
...
<script>
import ZoomModule from './ZoomModule/ZoomModule';
...
export default {
  ...
  methods: {
    getDetailData () {
      this.$store.dispatch('detailOptions/detailList', this.$route.params.id);
    },
    resetSaleAttrValue (spuSaleAttrValue, spuSaleAttrValueList) {
      spuSaleAttrValueList.forEach(spuSaleAttrValue => {
        spuSaleAttrValue.isChecked = '0';
      });
      spuSaleAttrValue.isChecked = '1';
    },
    changeProductNum (event) {
      let value = event.target.value * 1;
      if (isNaN(value) || value < 1) {
        this.productNum = 1;
      } else {
        this.productNum = parseInt(value);
      }
    },
    async addToCart () {
      try {
        await this.$store.dispatch('detailOptions/addOrUpdateProduct', { id: this.$route.params.id, productNum: this.productNum });
  ...
  components: { ZoomModule, ImageList },
}
</script>
